  ...
  <footer class="footer center">
    <div class="footer__flex">
      ...
      <!-- <div class="footer__info">
        ...
        <a href="index.html" class="footer__link text">Home</a>
        <a href="#" class="footer__link text">Project</a>
        <a href="blog.html" class="footer__link text">Blog</a>
      </div> -->
      <nav class="footer__info">
        <h3 class="subtitle">Pages</h3>
        <router-link class="footer__link text" to="/">Home</router-link>
        <router-link class="footer__link text" to="/project"
          >Project</router-link
        >
        <router-link class="footer__link text" to="/carousel">Blog</router-link>
      </nav>
      <router-view />
      <div class="footer__info">
        <h3 class="subtitle">Contact</h3>
        <p class="text">55 East Birchwood Ave. Brooklyn, New York 11201</p>
        <p class="text">contact@interno.com</p>
